...
export function SuccessAttestation({ attestationId, verifiedName, role, eventType = 'ETH_GLOBAL_BRUSSELS' }: SuccessAttestationProps) {
  ...
  if (eventType === 'ETHDENVER_COINBASE_CDP_2025') {
    ...
    eventDescription = "blockchain developer skills demonstrated";
  }

  return (
    <div className="mt-8">
      <h2 className="text-2xl font-bold mb-4">End of Registration</h2>
      <div className="card bg-success/10 shadow-lg">
        <div className="card-body">
          <div className="alert alert-success">
            ...
            <span>Congratulations! Your enrollment was publicly recorded on the Base Sepolia blockchain.</span>
          </div>

          <div className="mt-4">
            <p className="text-lg mb-2">Successfully registered for the upcoming <span className="font-semibold">{missionName}</span> as: <span className="font-semibold">{verifiedName}</span></p>
