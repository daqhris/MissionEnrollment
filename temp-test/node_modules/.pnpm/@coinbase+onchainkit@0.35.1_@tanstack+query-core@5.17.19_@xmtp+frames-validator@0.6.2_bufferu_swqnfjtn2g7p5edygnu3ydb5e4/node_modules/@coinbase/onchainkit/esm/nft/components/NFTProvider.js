...
const emptyContext = {};
const NFTContext = /*#__PURE__*/createContext(emptyContext);
...
function NFTProvider({
  ...
  const value = useValue(_objectSpread({
    contractAddress,
    tokenId,
    quantity,
  ...
  return /*#__PURE__*/jsx(NFTContext.Provider, {
    value: value,
    children: children
  });
}
export { NFTContext, NFTProvider, useNFTContext };
