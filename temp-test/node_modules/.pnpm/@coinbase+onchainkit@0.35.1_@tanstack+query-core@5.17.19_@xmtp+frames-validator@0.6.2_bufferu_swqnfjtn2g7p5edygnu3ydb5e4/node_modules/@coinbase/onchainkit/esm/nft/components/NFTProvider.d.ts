...
export declare function NFTProvider({ children, contractAddress, tokenId, useNFTData, buildMintTransaction, }: NFTProviderReact): import("react/jsx-runtime").JSX.Element;
