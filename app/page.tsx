                ...
                <>
                  ...
                  <div className="space-y-4 mb-8">
                    <p className="text-base-content/70 text-center">
                      This is an enrollment tool for a collaborative mission on the Base blockchain
                    </p>
                    <p className="text-base-content/70 text-center"><em>A tool openly built by a human and nonhumans <a href="https://github.com/daqhris/MissionEnrollment/graphs/contributors" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">since the summer of 2024</a></em></p>
                  </div>
