...
import { useOnboarding, Tooltip, GuidedTour, HelpButton, ProgressIndicator } from '../components/Onboarding';
import { identityTourSteps, attendanceTourSteps, attestationTourSteps, successTourSteps } from '../components/OnboardingTourSteps';
...
export default function Home() {
  ...
  return (
    <div className="container mx-auto p-8">
      ...
      {/* Guided Tour */}
      {currentStep === 'identity' && <GuidedTour steps={identityTourSteps} />}
      {currentStep === 'attendance' && <GuidedTour steps={attendanceTourSteps} />}
      {currentStep === 'attestation' && <GuidedTour steps={attestationTourSteps} />}
      {currentStep === 'success' && <GuidedTour steps={successTourSteps} />}
      
      <div className="bg-base-100 p-6 rounded-lg shadow-lg">
        <div className="space-y-4">
          <div className="card" id="welcome-card">
