              ...
              {!isConnected && (
                <>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <p className="text-base-content/70 text-center"><em>The tool is being openly built by a human and a non-human <a href="https://github.com/daqhris/MissionEnrollment/network" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">since summer 2024</a>.</em></p>
                  </div>
