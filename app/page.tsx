              ...
              {!isConnected && (
                <>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <p className="text-base-content/70 text-center"><em>The tool is being openly built by a human and a non-human <a href="https://github.com/daqhris/MissionEnrollment/commits/main" target="_blank" rel="noopener noreferrer">since summer 2024</a><ExternalLinkIcon />.</em></p>
                  </div>
