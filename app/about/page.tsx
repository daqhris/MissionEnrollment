        ...
        <div className="container mx-auto px-4 py-8">
          <div className="prose max-w-none bg-amber-200 p-8 md:px-16 rounded">
            ...
            <section className="mb-8">
              ...
              <p className="mt-4 text-gray-900">This enrollment tool is your first step in joining the participative and artistic adventure. We are bringing together various participants — starting with innovative minds who were present at specific international coding events — to preserve and spread citywide parade memories dating from <a href="https://www.zinneke.org/nl/album-photo/zinneke-parade-2024-2/" target="_blank" rel="noopener noreferrer"><strong>2024</strong></a><ExternalLinkIcon />, 2026 and onwards through blockchain technology.</p>

              <p className="mt-4 text-gray-900">The adventure unfolds into two chapters spanning several years: <em>first,</em> <strong>Mission Enrollment</strong> validates and welcomes friends and collaborators; <em>second,</em> the <strong>Zinneke Rescue Mission</strong> will launch to safeguard the visual souvenirs of festive events salvaged from drowning in torrential floodwaters. Together, we are writing a brilliant chapter in Brussels&apos; contemporary history of community, resilience, and art.</p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-amber-700">Our Inception Story</h2>
              <p className="text-gray-900">Born from two <a href="https://ethglobal.com" target="_blank" rel="noopener noreferrer"><strong>ETHGlobal</strong></a><ExternalLinkIcon /> hackathons, one held in-person and the next held <a href="https://ethglobal.com/events/superhack2024" target="_blank" rel="noopener noreferrer">virtually</a><ExternalLinkIcon /> during the <strong>summer of 2024</strong>, our rescue mission draws inspiration from the unique cultural heritage of Brussels. The <a href="https://www.zinneke.org/" target="_blank" rel="noopener noreferrer"><strong>Zinneke</strong></a><ExternalLinkIcon /> — named after street-roaming dogs that were banished to the banks of the Senne River from medieval times until the modern era — nowadays refers to anyone living in the city with a mixed heritage. We will be using a decentralized toolkit to circulate photographs, taken at the joint celebration of a legendary afterparty of the biennial Zinneke Parade and the closing night of the annual <a href="https://kfda.be/en/archives/" target="_blank" rel="noopener noreferrer"><strong>Kunstenfestivaldesarts</strong></a><ExternalLinkIcon /> in 2024, as <a href="https://github.com/daqhris/ZinnekeRescueMission?tab=readme-ov-file#rescue-strategy-onchain-postcards" target="_blank" rel="noopener noreferrer"><strong>onchain postcards</strong></a><ExternalLinkIcon />.</p>
            ...
            <section className="mb-8">
              ...
              <p className="mt-2 text-gray-900">A genius outcome to the artist <strong>daqhris</strong>, coding from the European Union&apos;s de facto capital, being sponsored by an American artificial intelligence company for a period of <strong>one human year</strong>. Sponsorship was formulated as free-of-charge assistance by the world&apos;s most advanced coding AI <strong>devin</strong>. The teamwork began in the summer of 2024, emboldened by teaming up with AI engineers during their beta and private phase, until the summer of 2025, when top trophies at an <a href="https://www.nytimes.com/2025/07/21/technology/google-ai-international-mathematics-olympiad.html" target="_blank" rel="noopener noreferrer">International Math Olympiad</a><ExternalLinkIcon /> were won by AIs scoring higher than human geniuses.</p>
