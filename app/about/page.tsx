            ...
            <section className="mb-8">
              ...
              <div className="mt-4 p-4 border rounded">
                ...
                <p className="mt-2">
                  ...
                  <a href="https://github.com/daqhris/MissionEnrollment/commit/429f7e4" target="_blank" rel="noopener noreferrer"><code>429f7e4</code></a> which provides aan independent record of <strong>human–AI co-authorship</strong>.
                </p>
              </div>
            </section>
