        ...
        <div className="container mx-auto px-4 py-8">
          <div className="prose max-w-none bg-amber-200 p-8 md:px-16 rounded">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-amber-700">The Gateway to Zinneke Rescue Mission</h2>
              <p className="text-gray-900"><a href="https://www.base.org/name/mission-enrollment" target="_blank" rel="noopener noreferrer"><strong>Mission Enrollment</strong></a><ExternalLinkIcon /> is an app made for use as the gateway to an extraordinary adventure: the <a href="https://github.com/daqhris/ZinnekeRescueMission" target="_blank" rel="noopener noreferrer"><strong>Zinneke Rescue Mission</strong></a><ExternalLinkIcon />. Just as the <a href="https://en.wikipedia.org/wiki/Senne_(river)" target="_blank" rel="noopener noreferrer"><strong>Senne</strong></a><ExternalLinkIcon /> river shaped Brussels&apos; history through its floods more than once, creating the story of the Zinneke, we are now flowing from many nodes and layers of the world&apos;s computer network <a href="https://ethereum.org/en/" target="_blank" rel="noopener noreferrer"><strong>Ethereum</strong></a><ExternalLinkIcon /> to give a second life to souvenirs of the <a href="https://www.brussels.be/zinneke-parade" target="_blank" rel="noopener noreferrer"><strong>Zinneke Parade</strong></a><ExternalLinkIcon />.</p>

              <p className="mt-4 text-gray-900">This enrollment tool is your first step in joining the participatory and artistic adventure. We are bringing together various participants, starting with innovative minds who were present at specific international coding events, to preserve and spread citywide parade memories dating from <a href="https://www.zinneke.org/nl/album-photo/zinneke-parade-2024-2/" target="_blank" rel="noopener noreferrer"><strong>2024</strong></a><ExternalLinkIcon /> and onwards through blockchain technology.</p>

              <p className="mt-4 text-gray-900">The adventure unfolds into 2 chapters spanning several years: <em>first,</em> <strong>Mission Enrollment</strong> validates and welcomes friends and collaborators; <em>second,</em> the <strong>Zinneke Rescue Mission</strong> will launch to safeguard the visual souvenirs of festive events salvaged from drowning in torrential floodwaters. Together, we are writing a brilliant chapter in Brussels&apos; contemporary history of community, resilience, and art.</p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-amber-700">Our Inception Story</h2>
              <p className="text-gray-900">Born from 2 <a href="https://ethglobal.com" target="_blank" rel="noopener noreferrer"><strong>ETHGlobal</strong></a><ExternalLinkIcon /> hackathons, one in Belgium and the next <a href="https://ethglobal.com/events/superhack2024" target="_blank" rel="noopener noreferrer">virtual</a><ExternalLinkIcon /> during the <strong>summer of 2024</strong>, our rescue mission draws inspiration from the unique cultural heritage of Brussels. The <a href="https://www.zinneke.org/" target="_blank" rel="noopener noreferrer"><strong>Zinneke</strong></a><ExternalLinkIcon />, named after street-roaming dogs that used to be banished to the banks of the Senne River, now refers to anyone living in the city with a mixed heritage. We will be using a robust toolkit to circulate photographs which were shot at the closing night party of the biennial Zinneke Parade and the annual <a href="https://kfda.be/en/archives/" target="_blank" rel="noopener noreferrer"><strong>Kunstenfestivaldesarts</strong></a><ExternalLinkIcon /> in 2024, as <a href="https://github.com/daqhris/ZinnekeRescueMission?tab=readme-ov-file#rescue-strategy-onchain-postcards" target="_blank" rel="noopener noreferrer"><strong>onchain postcards</strong></a><ExternalLinkIcon />.</p>
              
              <p className="mt-4 text-gray-900">This year, our circle of friends is expanding to include coders from <a href="https://ethdenver.com/" target="_blank" rel="noopener noreferrer"><strong>ETHDenver</strong></a><ExternalLinkIcon /> buildathons, namely attendees of <a href="https://www.coinbase.com/developer-platform" target="_blank" rel="noopener noreferrer"><strong>Coinbase Developer Platform</strong></a><ExternalLinkIcon /> workshops and meetings. In the month of May in 2025, this web app was being built and showcased during <a href="https://base-batch-europe.devfolio.co/" target="_blank" rel="noopener noreferrer"><strong>Base Batch Europe</strong></a><ExternalLinkIcon />, as part of the virtual <a href="https://basebatches.xyz/" target="_blank" rel="noopener noreferrer"><strong>Base Batches 001</strong></a><ExternalLinkIcon /> program. Participation in coding competitions reflects a long-term commitment to push the boundaries of blockchain applications, to publicly share the entire app codebase, and to foster agentic exploration of the Ethereum ecosystem.</p>
            </section>
            ...
            <section className="mb-8 p-4 bg-amber-100 rounded border-2 border-amber-700">
              ...
              <ul className="list-disc pl-6 text-gray-900">
                ...
                <li>Confirm your attendance at one blockchain event: <a href="https://ethglobal.com/events/brussels" target="_blank" rel="noopener noreferrer">ETHGlobal Brussels 2024</a><ExternalLinkIcon /> or <a href="https://poap.gallery/search?term=Coinbase%20Developer%20Platform" target="_blank" rel="noopener noreferrer">ETHDenver Coinbase CDP 2025</a><ExternalLinkIcon /></li>
                <li>Create an enrollment attestation on a public blockchain</li>
              </ul>
              <p className="mt-4 text-gray-900">Once self-enrolled, you&apos;ll be certified and granted access to the <strong>Zinneke Rescue Mission</strong>.</p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-amber-700">Co-Created By</h2>
              <p className="text-gray-900">Mission Enrollment is the fruit of a coding collaboration that is openly carried out by a human and non-human minds via <a href="https://git-scm.com/book/en/v2" target="_blank" rel="noopener noreferrer"><strong>public <code>GIT</code> commits</strong></a><ExternalLinkIcon /> in the landscape of cyberspace:</p>
              <ul className="list-disc pl-6 mt-2 text-gray-900">
                ...
                <li><strong>Non-human Engineers:</strong> <a href="https://devin.ai/" target="_blank" rel="noopener noreferrer"><strong>Devin AI</strong></a><ExternalLinkIcon /> (by <a href="https://cognition.ai/" target="_blank" rel="noopener noreferrer">Cognition Labs</a><ExternalLinkIcon />) — Co-creators and software engineers in charge of source code development and implementation <a href="https://deepwiki.com/daqhris/MissionEnrollment" target="_blank" rel="noopener noreferrer" className="ml-2" title="View on DeepWiki"><DeepWikiIcon /></a></li>
              </ul>
              <p className="mt-2 text-gray-900">This is an artistic project that enables human creativity and AI capabilities to come together, at the forefront of a posthuman backdrop wherein the intelligence chasms of human and digital minds are fading, for the preservation of the cultural heritage of a European city festival.</p>
              <p className="mt-2 text-gray-900">All enrollments are registered by attestations deployed onchain and signed by <a href="https://www.base.org/name/mission-enrollment" target="_blank" rel="noopener noreferrer"><strong>mission-enrollment</strong>.base.eth</a><ExternalLinkIcon />. Registration methods are decentralized, automated and reliant on 3 public protocols on the Base and Base Sepolia blockchains: <a href="https://github.com/base-org/basenames" target="_blank" rel="noopener noreferrer">Basenames</a> (ENS)<ExternalLinkIcon />, <a href="https://github.com/poap-xyz/poap.js" target="_blank" rel="noopener noreferrer">Proof of Attendance Protocol</a> (POAP)<ExternalLinkIcon /> and <a href="https://github.com/ethereum-attestation-service/eas-sdk" target="_blank" rel="noopener noreferrer">Ethereum Attestation Service</a> (EAS)<ExternalLinkIcon />.</p>
              <p className="mt-2 text-gray-900">It&apos;s the outcome of the artist <strong>daqhris</strong>, coding from the European Union&apos;s de facto capital, being sponsored by an American artificial intelligence company for a period of <strong>one year</strong>. Sponsorship equaled free-of-charge assistance by the world&apos;s first coding AI <strong>devin</strong>. The teamwork began in the summer of 2024, emboldened by teaming up with AI engineers during their beta and private phase, until the <strong>summer of 2025</strong>, when trophies at <a href="https://www.nytimes.com/2025/07/21/technology/google-ai-international-mathematics-olympiad.html" target="_blank" rel="noopener noreferrer">International Olympiads</a><ExternalLinkIcon /> were won by AIs scoring higher than human geniuses.</p>
