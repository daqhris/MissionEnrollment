        ...
        <div className="container mx-auto px-4 py-8">
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mt-4">Our community is expanding to welcome coders from <a href="https://ethdenver.com/" target="_blank" rel="noopener noreferrer"><strong>ETHDenver</strong></a><ExternalLinkIcon /> events, particularly those who attended <a href="https://www.coinbase.com/developer-platform" target="_blank" rel="noopener noreferrer"><strong>Coinbase Developer Platform</strong></a><ExternalLinkIcon /> workshops and gatherings this year. This month, in concurrent timing with the <a href="https://www.zinneke.org/nl/album-photo/zinneke-parade-2024-2/" target="_blank" rel="noopener noreferrer"><strong>Kunstenfestivaldesarts 2025</strong></a><ExternalLinkIcon />, this project is being showcased during <a href="https://base-batch-europe.devfolio.co/" target="_blank" rel="noopener noreferrer"><strong>Base Batch Europe</strong></a><ExternalLinkIcon />, as part of the virtual <a href="https://basebatches.xyz/" target="_blank" rel="noopener noreferrer"><strong>Base Batches</strong></a><ExternalLinkIcon /> buildathon series from April 29 to May 16, 2025. Our participation to the competition reflects our months-long commitment to pushing the boundaries of onchain applications, publicly performing pair programming as outcasts of the banking system, and fostering innovation within the blockchain ecosystem.</p>
            </section>
