        ...
        <div className="container mx-auto px-4 py-8">
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mt-2">All enrollments are registered by in-test attestations linked to <a href="https://www.base.org/name/mission-enrollment" target="_blank" rel="noopener noreferrer"><strong>mission-enrollment</strong>.base.eth</a> <ExternalLinkIcon />. Registration methods are reliant on 3 public protocols on the Base Sepolia blockchain: <a href="https://github.com/base-org/basenames" target="_blank" rel="noopener noreferrer">Basenames</a> <ExternalLinkIcon /> (ENS), <a href="https://github.com/poap-xyz/poap.js" target="_blank" rel="noopener noreferrer">Proof of Attendance Protocol</a> <ExternalLinkIcon /> (POAP) and <a href="https://github.com/ethereum-attestation-service/eas-sdk" target="_blank" rel="noopener noreferrer">Ethereum Attestation Service</a> <ExternalLinkIcon /> (EAS).</p>
              ...
              <div className="mt-4 p-4 border rounded">
                ...
                <p className="mt-2">
                  ...
                  <a href="https://github.com/daqhris?achievement=pair-extraordinaire&tab=achievements" target="_blank" rel="noopener noreferrer">
                    'Pair Extraordinaire'
                  </a> <ExternalLinkIcon /> achievement on <a href="https://github.com/daqhris/MissionEnrollment/pull/177" target="_blank" rel="noopener noreferrer">GitHub</a> <ExternalLinkIcon />, following the commit{' '}
