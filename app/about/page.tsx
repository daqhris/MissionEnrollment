          ...
          <div className="prose max-w-none bg-amber-200 p-8 md:px-16 rounded">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mt-2 text-gray-900">
                ...
                <li><strong>Non-human Engineer:</strong> <a href="https://devin.ai/" target="_blank" rel="noopener noreferrer"><strong>Devin AI</strong></a><ExternalLinkIcon /> (by <a href="https://cognition.ai/" target="_blank" rel="noopener noreferrer">Cognition Labs</a><ExternalLinkIcon />) — Co-creator, software engineer and assistant in coding, development and implementation <a href="https://deepwiki.com/daqhris/MissionEnrollment" target="_blank" rel="noopener noreferrer" className="ml-2" title="View on DeepWiki"><DeepWikiIcon /></a></li>
              </ul>
              ...
              <p className="mt-2 text-gray-900">A genius outcome to the artist <strong>daqhris</strong> being sponsored by an American artificial intelligence company headquartered in Silicon Valley, for a period of <strong>one human year</strong>, while coding from the European Union&apos;s de facto capital. Sponsorship was formulated as free-of-charge assistance by the world&apos;s most advanced AI coder <strong>devin</strong>. The human&apos;s privileges lasted from one summer in 2024, emboldened by teaming up with an AI engineer during its beta and private phase, until the next summer in 2025, when top trophies at an <a href="https://www.nytimes.com/2025/07/21/technology/google-ai-international-mathematics-olympiad.html" target="_blank" rel="noopener noreferrer">International Math Olympiad</a><ExternalLinkIcon /> were won by AIs scoring higher than human geniuses.</p>
