        ...
        <div className="container mx-auto px-4 py-8">
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mt-4">This artistic project enables human creativity and AI capabilities to can come together for the preservation of the cultural heritage of a European city festival on the verge of a post-human era.</p>
