          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mt-2">
                <li><strong>Human Author:</strong> <a href="https://www.base.org/name/daqhris" target="_blank" rel="noopener noreferrer"><strong>daqhris</strong>.base.eth</a><ExternalLinkIcon /> | <a href="https://warpcast.com/daqhris" target="_blank" rel="noopener noreferrer">Farcaster</a><ExternalLinkIcon /> - Creator, project architect and blockchain developer</li>
