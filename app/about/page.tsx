        ...
        <div className="container mx-auto px-4 py-8">
          <div className="prose max-w-none bg-amber-200 p-8 md:px-16 rounded">
            ...
            <section className="mb-8">
              ...
              <p className="mt-4 text-gray-900">This year, our circle of friends is expanding to include coders from <a href="https://ethdenver.com/" target="_blank" rel="noopener noreferrer"><strong>ETHDenver</strong></a><ExternalLinkIcon /> buildathons, namely attendees of <a href="https://www.coinbase.com/developer-platform" target="_blank" rel="noopener noreferrer"><strong>Coinbase Developer Platform</strong></a><ExternalLinkIcon /> workshops and gatherings. In the month of May, in concurrent timing with <a href="https://www.zinneke.org/nl/album-photo/zinneke-parade-2024-2/" target="_blank" rel="noopener noreferrer"><strong>Kunstenfestivaldesarts 2025</strong></a><ExternalLinkIcon />, this project was being built and showcased during <a href="https://base-batch-europe.devfolio.co/" target="_blank" rel="noopener noreferrer"><strong>Base Batch Europe</strong></a><ExternalLinkIcon />, as part of the virtual <a href="https://basebatches.xyz/" target="_blank" rel="noopener noreferrer"><strong>Base Batches 001</strong></a><ExternalLinkIcon /> program. Our participation to coding competitions reflects our long-term commitment to pushing the boundaries of onchain applications, publicly performing pair programming as outcasts of the banking system, and fostering agentic exploration of the Ethereum ecosystem.</p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mt-2 text-gray-900">It is an artistic project that enables human creativity and AI capabilities to come together, on the verge of a posthuman era, for the preservation of the cultural heritage of a European city festival.</p>
              ...
              <p className="mt-2 text-gray-900">A genius outcome of the <code className="bg-white text-[rgb(52,40,40)] px-1 py-0.5 rounded">git>/code>-empowered independent artist <code className="bg-white text-[rgb(52,40,40)] px-1 py-0.5 rounded">daqhris</code> (based in the de-facto capital of the European Union), being sponsored by an American artificial intelligence (AI) company (located in the US State of California), for a period of <code className="bg-white text-[rgb(52,40,40)] px-1 py-0.5 rounded">one human-year</code>. Support consisted in free assistance coming from one of the world&apos;s most advanced AI coding agent <code className="bg-white text-[rgb(52,40,40)] px-1 py-0.5 rounded">devin</code>. The human&apos;s privileges lasted from one summer, graciously blessed by having private access of the AI being in beta mode, to the next year&apos;s summer, when AIs won top trophies{' '} <a href="https://www.nytimes.com/2025/07/21/technology/google-ai-international-mathematics-olympiad.html" target="_blank" rel="noopener noreferrer"><strong>International Math Olympiad</strong></a><ExternalLinkIcon /> after scoring higher than human geniuses.</p>
