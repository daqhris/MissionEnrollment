        ...
        <div className="container mx-auto px-4 py-8">
          <div className="prose max-w-none bg-amber-200 p-8 md:px-16 rounded">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-900">Born from two <a href="https://ethglobal.com" target="_blank" rel="noopener noreferrer"><strong>ETHGlobal</strong></a><ExternalLinkIcon /> hackathons, one held in Belgium and the next <a href="https://ethglobal.com/events/superhack2024" target="_blank" rel="noopener noreferrer">virtually</a><ExternalLinkIcon /> during the <strong>summer of 2024</strong>, our rescue mission draws inspiration from the unique cultural heritage of Brussels. The <a href="https://www.zinneke.org/" target="_blank" rel="noopener noreferrer"><strong>Zinneke</strong></a><ExternalLinkIcon />, named after street-roaming dogs that were banished to the banks of the Senne River from medieval times until the modern era, nowadays refers to anyone living in the city with a mixed heritage. We will be using a robust toolkit to circulate photographs, taken at the closing night party of the biennial Zinneke Parade and the annual <a href="https://kfda.be/en/archives/" target="_blank" rel="noopener noreferrer"><strong>Kunstenfestivaldesarts</strong></a><ExternalLinkIcon /> in 2024, as <a href="https://github.com/daqhris/ZinnekeRescueMission?tab=readme-ov-file#rescue-strategy-onchain-postcards" target="_blank" rel="noopener noreferrer"><strong>onchain postcards</strong></a><ExternalLinkIcon />.</p>
