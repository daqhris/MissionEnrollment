        ...
        <div className="container mx-auto px-4 py-8">
          <div className="prose max-w-none bg-amber-200 p-8 md:px-16 rounded">
            ...
            <section className="mb-8">
              ...
              <p className="mt-2 text-gray-900">A genius outcome to the git-empowered independent artist <strong>daqhris</strong> (based in the de-facto capital of the European Union), being sponsored by an American artificial intelligence (AI) company (located in the US State of California), for a period of <strong>one human-year</strong>. Support consisted in free assistance coming from one of the world&apos;s most advanced AI coding agent <strong>devin</strong>. The human&apos;s privileges lasted from one summer, graciously blessed by having private access of the AI being in beta mode, to the next year&apos;s summer, when AIs won top trophies <a href="https://www.nytimes.com/2025/07/21/technology/google-ai-international-mathematics-olympiad.html" target="_blank" rel="noopener noreferrer">International Math Olympiad</a><ExternalLinkIcon /> after scoring higher than human geniuses.</p>
