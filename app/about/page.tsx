        ...
        <div className="container mx-auto px-4 py-8">
          <div className="prose max-w-none bg-amber-200 p-8 md:px-16 rounded">
            ...
            <section className="mb-8">
              ...
              <p className="mt-2 text-gray-900">A genius outcome of the <code>git>/code>-empowered independent artist <strong>daqhris</strong>, based in the de-facto capital of the European Union, being sponsored by an American artificial intelligence (AI) company, located in the US State of California, for a period of <code>one human-year</code>. Support consisted in free assistance coming from one of the world's most advanced AI coding agent <strong>devin</strong>. The human's privileges lasted from one summer, kicked off by having private access of the AI being in beta mode, to the next year's summer, when AIs won top trophies <a href="https://www.nytimes.com/2025/07/21/technology/google-ai-international-mathematics-olympiad.html" target="_blank" rel="noopener noreferrer">International Math Olympiad<strong></strong></a><ExternalLinkIcon /> after scoring higher than human genius competitors.</p>
