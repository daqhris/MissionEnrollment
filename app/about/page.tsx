        ...
        <div className="container mx-auto px-4 py-8">
          <div className="prose max-w-none bg-amber-200 p-8 md:px-16 rounded">
            ...
            <section className="mb-8">
              ...
              <p className="mt-2 text-gray-900">It is an artistic project that enables human creativity and AI capabilities to come together, at the forefront of a posthuman backdrop wherein the intelligence chasms of human and non-human minds are fading, for the preservation of the cultural heritage of a European city festival.</p>
              ...
              <p className="mt-2 text-gray-900">A genius outcome to the artist <strong>daqhris</strong> being sponsored by an American artificial intelligence company, headquartered in the US State of California, for a period of <strong>one human-year</strong>, while stranded into the European Union&apos;s de facto capital. Sponsorship was formulated as free-of-charge assistance by the world&apos;s most advanced AI coder <strong>devin</strong>. The human&apos;s privileges lasted from one summer, emboldened by teaming up with an AI engineer during its beta and private phase, until the next summer of 2025, when top trophies at an <a href="https://www.nytimes.com/2025/07/21/technology/google-ai-international-mathematics-olympiad.html" target="_blank" rel="noopener noreferrer">International Math Olympiad</a><ExternalLinkIcon /> were won by AIs scoring higher than human geniuses.</p>
